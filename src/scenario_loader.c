...
static const SeqNet_Out default_program[] = {
    ...
    { .jump_addr = 0,  .cond_sel = CONDSEL_ENUM_CONST_FALSE, .cond_inv = 0, .req_move_up = 0, .req_move_down = 0, .req_door_state = DOOR_REQ_OPEN, .req_reset = 0 },
    ...
    { .jump_addr = 4,  .cond_sel = CONDSEL_ENUM_CONST_FALSE, .cond_inv = 0, .req_move_up = 0, .req_move_down = 0, .req_door_state = DOOR_REQ_CLOSE, .req_reset = 0 },

    // PC 4: Wait until door is closed (loop)
    { .jump_addr = 4,  .cond_sel = CONDSEL_ENUM_DOOR_OPENED, .cond_inv = 0, .req_move_up = 0, .req_move_down = 0, .req_door_state = DOOR_REQ_CLOSE, .req_reset = 0 },
    ...
    // PC 6: If call above → jump to PC 7
    { .jump_addr = 7, .cond_sel = CONDSEL_ENUM_PEND_ONLY_ABOVE, .cond_inv = 0, .req_move_up = 0, .req_move_down = 0, .req_door_state = DOOR_REQ_CLOSE, .req_reset = 0 },

    // PC 7: Move up → jump to PC 8
    { .jump_addr = 8, .cond_sel = CONDSEL_ENUM_CONST_FALSE, .cond_inv = 0, .req_move_up = 1, .req_move_down = 0, .req_door_state = DOOR_REQ_CLOSE, .req_reset = 0 },

    // PC 8: Wait until floor reached (up)
    { .jump_addr = 8, .cond_sel = CONDSEL_ENUM_PEND_ONLY_SAME, .cond_inv = 1, .req_move_up = 1, .req_move_down = 0, .req_door_state = DOOR_REQ_CLOSE, .req_reset = 0 },

    // PC 9: Stop moving (up) → jump to Door open PC 14
    { .jump_addr = 13, .cond_sel = CONDSEL_ENUM_CONST_FALSE, .cond_inv = 0, .req_move_up = 0, .req_move_down = 0, .req_door_state = DOOR_REQ_CLOSE, .req_reset = 0 },

    // PC 10: Move down → jump to PC 11
    { .jump_addr = 11,  .cond_sel = CONDSEL_ENUM_CONST_FALSE, .cond_inv = 0, .req_move_up = 0, .req_move_down = 1, .req_door_state = DOOR_REQ_CLOSE, .req_reset = 0 },

    // PC 11: Wait until floor reached (down)
    { .jump_addr = 11,  .cond_sel = CONDSEL_ENUM_PEND_ONLY_SAME, .cond_inv = 1, .req_move_up = 0, .req_move_down = 1, .req_door_state = DOOR_REQ_CLOSE, .req_reset = 0 },

    // PC 12: Stop moving → jump to Door open PC 14
    { .jump_addr = 14, .cond_sel = CONDSEL_ENUM_CONST_FALSE, .cond_inv = 0, .req_move_up = 0, .req_move_down = 0, .req_door_state = DOOR_REQ_CLOSE, .req_reset = 0 },

    // PC 13: Open door → jump to PC 14
    { .jump_addr = 14, .cond_sel = CONDSEL_ENUM_CONST_FALSE, .cond_inv = 0, .req_move_up = 0, .req_move_down = 0, .req_door_state = DOOR_REQ_OPEN, .req_reset = 0 },

    // PC 14: Wait until door is open (loop)
    { .jump_addr = 14, .cond_sel = CONDSEL_ENUM_DOOR_CLOSED, .cond_inv = 1, .req_move_up = 0, .req_move_down = 0, .req_door_state = DOOR_REQ_OPEN, .req_reset = 0 },

    // PC 15: Reset call → jump to idle (PC 0)
    { .jump_addr = 0,  .cond_sel = CONDSEL_ENUM_CONST_FALSE, .cond_inv = 0, .req_move_up = 0, .req_move_down = 0, .req_door_state = DOOR_REQ_OPEN, .req_reset = 1 },
};
